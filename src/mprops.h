...
#ifndef ITRACK_PROPS_H
#define ITRACK_PROPS_H
...
// // float, 1 value
// #define ITRACK_PROP_SENSITIVITY "Trackpad Sensitivity"
// int, 2 values - finger low, finger high
#define ITRACK_PROP_PRESSURE "Trackpad Touch Pressure"
// int, 2 values - enable buttons, has integrated button
// #define ITRACK_PROP_BUTTON_SETTINGS "Trackpad Button Settings"
// // int, 4 values - enable button zones, button move emulation, emulation touch expiration, button zone in edge bottom
// #define ITRACK_PROP_BUTTON_EMULATE_SETTINGS "Trackpad Button Emulation Settings"
// // int, 7 values - button to emulate with 0 touch, 1 touch, 2 touches, 3 touches AND zone 1, zone 2, zone 3
// #define ITRACK_PROP_BUTTON_EMULATE_VALUES "Trackpad Button Emulation Values"
// // int, 3 values - click time, touch timeout, invalidate distance
// #define ITRACK_PROP_TAP_SETTINGS "Trackpad Tap Settings"
// // int, 4 values - 1 touch button, 2 touch button, 3 touch button, 4 touch button
// #define ITRACK_PROP_TAP_EMULATE "Trackpad Tap Button Emulation"
// int, 2 values - ignore thumb touches, disable trackpad on thumb touches
#define ITRACK_PROP_THUMB_DETECT "Trackpad Thumb Detection"
// int, 2 values - size, width to length ratio
#define ITRACK_PROP_THUMB_SIZE "Trackpad Thumb Size"
// int, 2 values - ignore palm touches, disable trackpad on palm touches
#define ITRACK_PROP_PALM_DETECT "Trackpad Palm Detection"
// int, 1 value - size
#define ITRACK_PROP_PALM_SIZE "Trackpad Palm Size"
// // int, 2 value - button hold, wait time
// #define ITRACK_PROP_GESTURE_SETTINGS "Trackpad Gesture Settings"
// // int, 1 value - enable high precision scrolling
// #define ITRACK_PROP_SMOOTH_SCROLL "Trackpad Smooth Scroll"
// // int, 3 values
...
// #define ITRACK_PROP_SCROLL_SETTINGS "Trackpad Scroll Settings"
// // int, 4 values - up button, down button, left button, right button
// #define ITRACK_PROP_SCROLL_BUTTONS "Trackpad Scroll Buttons"
// // int, 3 values - enable coasting, coasting enable speed, decelaration amount
// #define ITRACK_PROP_SCROLL_COAST "Trackpad Scroll Coasting"
// // int, 2 values
...
// #define ITRACK_PROP_SWIPE_SETTINGS "Trackpad Swipe Settings"
// // int, 4 values - up button, down button, left button, right button
// #define ITRACK_PROP_SWIPE_BUTTONS "Trackpad Swipe Buttons"
// // int, 3 values
...
// #define ITRACK_PROP_SWIPE4_SETTINGS "Trackpad Swipe4 Settings"
// // int, 4 values - up button, down button, left button, right button
// #define ITRACK_PROP_SWIPE4_BUTTONS "Trackpad Swipe4 Buttons"
// // int, 7 values
...
// #define ITRACK_PROP_EDGE_SCROLL_SETTINGS "Trackpad Edge Scroll Settings"
// int, 4 value - size of edge regions that are ignored: {up,down,left,right}
#define ITRACK_PROP_EDGE_SIZES "Trackpad Edge Sizes"
// // int, 1 value - distance before a scale event is triggered
// #define ITRACK_PROP_SCALE_DIST "Trackpad Scale Distance"
// // int, 2 values - up button, down button
// #define ITRACK_PROP_SCALE_BUTTONS "Trackpad Scale Buttons"
// // int, 1 value - distance before a rotate event is triggered
// #define ITRACK_PROP_ROTATE_DIST "Trackpad Rotate Distance"
// // int, 2 values - left button, right button
// #define ITRACK_PROP_ROTATE_BUTTONS "Trackpad Rotate Buttons"
// // int, 2 values - hold&move with one stationary and one moving finger
// //   first: stationary finger max move distance
// //   second: button
// #define ITRACK_PROP_HOLD1_MOVE1_STATIONARY_SETTINGS "Trackpad Hold1Move1 Stationary Settings"
// // int, 2 values
// //   first: distance before a four swipe event is triggered
// //   second: how much milliseconds button will be hold after gesture
// #define ITRACK_PROP_HOLD1_MOVE1_SETTINGS "Trackpad Hold1Move1 Settings"
// // int, 4 values - up button, down button, left button, right button
// #define ITRACK_PROP_HOLD1_MOVE1_BUTTONS "Trackpad Hold1Move1 Buttons"

// // int, 2 values - hold&move with one stationary and two moving fingers
// //   first: stationary finger max move distance
// //   second: button
// #define ITRACK_PROP_HOLD1_MOVE2_STATIONARY_SETTINGS "Trackpad Hold1Move2 Stationary Settings"
// // int, 2 values
// //   first: distance before a four swipe event is triggered
// //   second: how much milliseconds button will be hold after gesture
// #define ITRACK_PROP_HOLD1_MOVE2_SETTINGS "Trackpad Hold1Move2 Settings"
// // int, 4 values - up button, down button, left button, right button
// #define ITRACK_PROP_HOLD1_MOVE2_BUTTONS "Trackpad Hold1Move2 Buttons"

// // int, 2 values - hold&move with one stationary and three moving finger
// //   first: stationary finger max move distance
// //   second: button
// #define ITRACK_PROP_HOLD1_MOVE3_STATIONARY_SETTINGS "Trackpad Hold1Move3 Stationary Settings"
// // int, 2 values
// //   first: distance before a four swipe event is triggered
// //   second: how much milliseconds button will be hold after gesture
// #define ITRACK_PROP_HOLD1_MOVE3_SETTINGS "Trackpad Hold1Move3 Settings"
// // int, 4 values - up button, down button, left button, right button
// #define ITRACK_PROP_HOLD1_MOVE3_BUTTONS "Trackpad Hold1Move3 Buttons"

// // int, 5 values - enable, timeout, wait, dist, lock timeout
// #define ITRACK_PROP_DRAG_SETTINGS "Trackpad Drag Settings"
// int, 2 values - invert x axis, invert y axis
#define ITRACK_PROP_AXIS_INVERT "Trackpad Axis Inversion"
