...
// 	mprops.sensitivity = atom_init_float(local->dev, ITRACK_PROP_SENSITIVITY, 1, fvals, mprops.float_type);

	ivals[0] = cfg->touch_down;
	ivals[1] = cfg->touch_up;
	mprops.pressure = atom_init_integer(local->dev, ITRACK_PROP_PRESSURE, 2, ivals, 8);

// 	ivals[0] = cfg->button_enable;
// 	ivals[1] = cfg->button_integrated;
// 	mprops.button_settings = atom_init_integer(local->dev, ITRACK_PROP_BUTTON_SETTINGS, 2, ivals, 8);

// 	ivals[0] = cfg->button_zones;
// 	ivals[1] = cfg->button_move;
// 	ivals[2] = cfg->button_expire;
// 	ivals[3] = cfg->is_button_zones_height_limited;
// 	mprops.button_emulate_settings = atom_init_integer(local->dev, ITRACK_PROP_BUTTON_EMULATE_SETTINGS, 4, ivals, 16);
...
// 	mprops.button_emulate_values = atom_init_integer(local->dev, ITRACK_PROP_BUTTON_EMULATE_VALUES, 7, ivals, 8);

// 	ivals[0] = cfg->tap_hold;
// 	ivals[1] = cfg->tap_timeout;
// 	ivals[2] = cfg->tap_dist;
// 	mprops.tap_settings = atom_init_integer(local->dev, ITRACK_PROP_TAP_SETTINGS, 3, ivals, 32);

// 	ivals[0] = cfg->tap_1touch;
// 	ivals[1] = cfg->tap_2touch;
// 	ivals[2] = cfg->tap_3touch;
// 	ivals[3] = cfg->tap_4touch;
// 	mprops.tap_emulate = atom_init_integer(local->dev, ITRACK_PROP_TAP_EMULATE, 4, ivals, 8);
...
// 	mprops.gesture_settings = atom_init_integer(local->dev, ITRACK_PROP_GESTURE_SETTINGS, 2, ivals, 16);

// 	ivals[0] = cfg->scroll_smooth;
// 	mprops.scroll_smooth = atom_init_integer(local->dev, ITRACK_PROP_SMOOTH_SCROLL, 1, ivals, 8);

// 	init_swipe_props(local->dev, &mprops.scroll, &cfg->scroll, ITRACK_PROP_SCROLL_SETTINGS, ITRACK_PROP_SCROLL_BUTTONS);

// 	init_swipe_props(local->dev, &mprops.swipe3, &cfg->swipe3, ITRACK_PROP_SWIPE_SETTINGS, ITRACK_PROP_SWIPE_BUTTONS);

// 	init_swipe_props(local->dev, &mprops.swipe4, &cfg->swipe4, ITRACK_PROP_SWIPE4_SETTINGS, ITRACK_PROP_SWIPE4_BUTTONS);

// 	fvals[0] = cfg->scroll_coast.min_speed;
// 	fvals[1] = cfg->scroll_coast.duration; /* = duration in miliseconds */
// 	mprops.scroll_coast = atom_init_float(local->dev, ITRACK_PROP_SCROLL_COAST, 2, fvals, mprops.float_type);

// 	init_edge_props(local->dev, &mprops.edge_scroll, &cfg->edge_scroll, ITRACK_PROP_EDGE_SCROLL_SETTINGS);
...
// 	mprops.scale_dist = atom_init_integer(local->dev, ITRACK_PROP_SCALE_DIST, 1, ivals, 32);

// 	ivals[0] = cfg->scale_up_btn;
// 	ivals[1] = cfg->scale_dn_btn;
// 	mprops.scale_buttons = atom_init_integer(local->dev, ITRACK_PROP_SCALE_BUTTONS, 2, ivals, 8);

// 	ivals[0] = cfg->rotate_dist;
// 	mprops.rotate_dist = atom_init_integer(local->dev, ITRACK_PROP_ROTATE_DIST, 1, ivals, 32);

// 	ivals[0] = cfg->rotate_lt_btn;
// 	ivals[1] = cfg->rotate_rt_btn;
// 	mprops.rotate_buttons = atom_init_integer(local->dev, ITRACK_PROP_ROTATE_BUTTONS, 2, ivals, 8);

// 	ivals[0] = cfg->hold1_move1_stationary.max_move;
// 	ivals[1] = cfg->hold1_move1_stationary.button;
// 	mprops.hold1_move1_stationary = atom_init_integer(local->dev, ITRACK_PROP_HOLD1_MOVE1_STATIONARY_SETTINGS, 2, ivals, 32);

// 	init_swipe_props(local->dev, &mprops.hold1_move1, &cfg->hold1_move1, ITRACK_PROP_HOLD1_MOVE1_SETTINGS, ITRACK_PROP_HOLD1_MOVE1_BUTTONS);

// #if 0
// 	ivals[0] = cfg->hold1_move2_stationary.max_move;
// 	ivals[1] = cfg->hold1_move2_stationary.button;
// 	mprops.hold1_move2_stationary = atom_init_integer(local->dev, ITRACK_PROP_HOLD1_MOVE2_STATIONARY_SETTINGS, 2, ivals, 32);

// 	init_swipe_props(local->dev, &mprops.hold1_move2, &cfg->hold1_move2, ITRACK_PROP_HOLD1_MOVE2_SETTINGS, ITRACK_PROP_HOLD1_MOVE2_BUTTONS);


// 	ivals[0] = cfg->hold1_move3_stationary.max_move;
// 	ivals[1] = cfg->hold1_move3_stationary.button;
// 	mprops.hold1_move3_stationary = atom_init_integer(local->dev, ITRACK_PROP_HOLD1_MOVE3_STATIONARY_SETTINGS, 2, ivals, 32);

// 	init_swipe_props(local->dev, &mprops.hold1_move3, &cfg->hold1_move3, ITRACK_PROP_HOLD1_MOVE3_SETTINGS, ITRACK_PROP_HOLD1_MOVE3_BUTTONS);
// #endif
...
// 	mprops.drag_settings = atom_init_integer(local->dev, ITRACK_PROP_DRAG_SETTINGS, 5, ivals, 32);
...
// static int check_buttons_property(XIPropertyValuePtr prop, uint8_t** buttons_ret_arr, int buttons_count)
// {
// 	uint8_t* ivals8;
// 	int i;
